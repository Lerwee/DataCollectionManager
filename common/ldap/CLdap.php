<?php
namespace app\customs\zapi\common\ldap;
...
class CLdap {
	...
	protected $cnf = [
		...
		'referrals'			=> 0,
		'version'			=> 3,
		'start_tls'			=> PRS_AUTH_START_TLS_OFF,
		'deref'				=> null
	];
	...
	public function __construct(array $config = []) {
		...
		$this->cnf = prs_array_merge($this->cnf, $config);
	 ...
	 * For DN string "cn=perseus-admins,ou=Group,dc=example,dc=org" and the "Group name attribute" set to "cn",
	 * the string "perseus-admins" will be stored to the $groups array.
	 *
