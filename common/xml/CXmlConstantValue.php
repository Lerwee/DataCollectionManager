...
use app\customs\zapi\common\helpers\MediaTypeHelper;
...
class CXmlConstantValue {
	...
	const PERSEUS = INTERFACE_TYPE_AGENT;
	...
	const TRIGGER_EXPRESSION = PRS_RECOVERY_MODE_EXPRESSION;
	const TRIGGER_RECOVERY_EXPRESSION = PRS_RECOVERY_MODE_RECOVERY_EXPRESSION;
	const TRIGGER_NONE = PRS_RECOVERY_MODE_NONE; // Duplicate.

	const TRIGGER_DISABLED = PRS_TRIGGER_CORRELATION_NONE; // Duplicate.
	const TRIGGER_TAG_VALUE = PRS_TRIGGER_CORRELATION_TAG;
	...
	// const NONE = PRS_HTTP_AUTH_NONE; // Duplicate.
	const BASIC = PRS_HTTP_AUTH_BASIC;
	const NTLM = PRS_HTTP_AUTH_NTLM;
	const KERBEROS = PRS_HTTP_AUTH_KERBEROS;
	const DIGEST = PRS_HTTP_AUTH_DIGEST;
	...
	const RAW = PRS_POSTTYPE_RAW;
	const JSON = PRS_POSTTYPE_JSON;
	const XML = PRS_POSTTYPE_XML;
	...
	const ITEM_TYPE_PERSEUS_PASSIVE = ITEM_TYPE_PERSEUS;
	...
	const ITEM_TYPE_PERSEUS_ACTIVE = ITEM_TYPE_PERSEUS_ACTIVE;
	...
	const ORIGINAL_ERROR = PRS_PREPROC_FAIL_DEFAULT;
	const DISCARD_VALUE = PRS_PREPROC_FAIL_DISCARD_VALUE;
	const CUSTOM_VALUE = PRS_PREPROC_FAIL_SET_VALUE;
	const CUSTOM_ERROR = PRS_PREPROC_FAIL_SET_ERROR;

	const MULTIPLIER = PRS_PREPROC_MULTIPLIER;
	const RTRIM = PRS_PREPROC_RTRIM;
	const LTRIM = PRS_PREPROC_LTRIM;
	const TRIM = PRS_PREPROC_TRIM;
	const REGEX = PRS_PREPROC_REGSUB;
	const BOOL_TO_DECIMAL = PRS_PREPROC_BOOL2DEC;
	const OCTAL_TO_DECIMAL = PRS_PREPROC_OCT2DEC;
	const HEX_TO_DECIMAL = PRS_PREPROC_HEX2DEC;
	const SIMPLE_CHANGE = PRS_PREPROC_DELTA_VALUE;
	const CHANGE_PER_SECOND = PRS_PREPROC_DELTA_SPEED;
	const XMLPATH = PRS_PREPROC_XPATH;
	const JSONPATH = PRS_PREPROC_JSONPATH;
	const IN_RANGE = PRS_PREPROC_VALIDATE_RANGE;
	const MATCHES_REGEX = PRS_PREPROC_VALIDATE_REGEX;
	const NOT_MATCHES_REGEX = PRS_PREPROC_VALIDATE_NOT_REGEX;
	const CHECK_JSON_ERROR = PRS_PREPROC_ERROR_FIELD_JSON;
	const CHECK_XML_ERROR = PRS_PREPROC_ERROR_FIELD_XML;
	const CHECK_REGEX_ERROR = PRS_PREPROC_ERROR_FIELD_REGEX;
	const CHECK_NOT_SUPPORTED = PRS_PREPROC_VALIDATE_NOT_SUPPORTED;
	const DISCARD_UNCHANGED = PRS_PREPROC_THROTTLE_VALUE;
	const DISCARD_UNCHANGED_HEARTBEAT = PRS_PREPROC_THROTTLE_TIMED_VALUE;
	const JAVASCRIPT = PRS_PREPROC_SCRIPT;
	const PROMETHEUS_PATTERN = PRS_PREPROC_PROMETHEUS_PATTERN;
	const PROMETHEUS_TO_JSON = PRS_PREPROC_PROMETHEUS_TO_JSON;
	const CSV_TO_JSON = PRS_PREPROC_CSV_TO_JSON;
	const STR_REPLACE = PRS_PREPROC_STR_REPLACE;
	const XML_TO_JSON = PRS_PREPROC_XML_TO_JSON;
	const SNMP_WALK_VALUE = PRS_PREPROC_SNMP_WALK_VALUE;
	const SNMP_WALK_TO_JSON = PRS_PREPROC_SNMP_WALK_TO_JSON;
	...
	const GENERIC_SMTP = MediaTypeHelper::EMAIL_PROVIDER_SMTP;
	const GMAIL = MediaTypeHelper::EMAIL_PROVIDER_GMAIL;
	const GMAIL_RELAY = MediaTypeHelper::EMAIL_PROVIDER_GMAIL_RELAY;
	const OFFICE365 = MediaTypeHelper::EMAIL_PROVIDER_OFFICE365;
	const OFFICE365_RELAY = MediaTypeHelper::EMAIL_PROVIDER_OFFICE365_RELAY;
	...
	const MACRO_TYPE_TEXT = PRS_MACRO_TYPE_TEXT;
	const MACRO_TYPE_SECRET = PRS_MACRO_TYPE_SECRET;
	const MACRO_TYPE_VAULT = PRS_MACRO_TYPE_VAULT;

	// Constants for low-level discovery rule overrides.
	const LLD_OVERRIDE_STOP_NO = PRS_LLD_OVERRIDE_STOP_NO;
	const LLD_OVERRIDE_STOP_YES = PRS_LLD_OVERRIDE_STOP_YES;
	...
	const LLD_OVERRIDE_OPERATION_STATUS_ENABLED = PRS_PROTOTYPE_STATUS_ENABLED;
	const LLD_OVERRIDE_OPERATION_STATUS_DISABLED = PRS_PROTOTYPE_STATUS_DISABLED;
	const LLD_OVERRIDE_OPERATION_DISCOVER = PRS_PROTOTYPE_DISCOVER;
	const LLD_OVERRIDE_OPERATION_NO_DISCOVER = PRS_PROTOTYPE_NO_DISCOVER;
	...
	const DASHBOARD_WIDGET_FIELD_TYPE_INTEGER = PRS_WIDGET_FIELD_TYPE_INT32;
	const DASHBOARD_WIDGET_FIELD_TYPE_STRING = PRS_WIDGET_FIELD_TYPE_STR;
	const DASHBOARD_WIDGET_FIELD_TYPE_HOST = PRS_WIDGET_FIELD_TYPE_HOST;
	const DASHBOARD_WIDGET_FIELD_TYPE_ITEM = PRS_WIDGET_FIELD_TYPE_ITEM;
	const DASHBOARD_WIDGET_FIELD_TYPE_ITEM_PROTOTYPE = PRS_WIDGET_FIELD_TYPE_ITEM_PROTOTYPE;
	const DASHBOARD_WIDGET_FIELD_TYPE_GRAPH = PRS_WIDGET_FIELD_TYPE_GRAPH;
	const DASHBOARD_WIDGET_FIELD_TYPE_GRAPH_PROTOTYPE = PRS_WIDGET_FIELD_TYPE_GRAPH_PROTOTYPE;
