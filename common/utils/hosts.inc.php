...
function ipmiAuthTypes($type = null) {
	$types = [
		IPMI_AUTHTYPE_DEFAULT => t('zapi', 'Default'),
		IPMI_AUTHTYPE_NONE => t('zapi', 'None'),
		IPMI_AUTHTYPE_MD2 => t('zapi', 'MD2'),
		IPMI_AUTHTYPE_MD5 => 'MD5',
		IPMI_AUTHTYPE_STRAIGHT => t('zapi', 'Straight'),
		IPMI_AUTHTYPE_OEM => t('zapi', 'OEM'),
		IPMI_AUTHTYPE_RMCP_PLUS => t('zapi', 'RMCP+')
	];
...
function ipmiPrivileges($type = null) {
	$types = [
		IPMI_PRIVILEGE_CALLBACK => t('zapi', 'Callback'),
		IPMI_PRIVILEGE_USER => t('zapi', 'User'),
		IPMI_PRIVILEGE_OPERATOR => t('zapi', 'Operator'),
		IPMI_PRIVILEGE_ADMIN => t('zapi', 'Admin'),
		IPMI_PRIVILEGE_OEM => t('zapi', 'OEM')
	];
...
function getHostInventories($orderedByTitle = false) {
	...
	$inventoryFields = [
		...
		2 => [
			'nr' => 2,
			'db_field' => 'type_full',
			'title' => t('zapi', 'Type (Full details)')
		],
		3 => [
			'nr' => 3,
			'db_field' => 'name',
		...
		6 => [
			'nr' => 6,
			'db_field' => 'os_full',
			'title' => t('zapi', 'OS (Full details)')
		],
		7 => [
			'nr' => 7,
			'db_field' => 'os_short',
			'title' => t('zapi', 'OS (Short)')
		],
		8 => [
			'nr' => 8,
			'db_field' => 'serialno_a',
			'title' => t('zapi', 'Serial number A')
		],
		9 => [
			'nr' => 9,
			'db_field' => 'serialno_b',
			'title' => t('zapi', 'Serial number B')
		],
		10 => [
			'nr' => 10,
			'db_field' => 'tag',
		...
		11 => [
			'nr' => 11,
			'db_field' => 'asset_tag',
			'title' => t('zapi', 'Asset tag')
		],
		12 => [
			'nr' => 12,
			'db_field' => 'macaddress_a',
			'title' => t('zapi', 'MAC address A')
		],
		13 => [
			'nr' => 13,
			'db_field' => 'macaddress_b',
			'title' => t('zapi', 'MAC address B')
		],
		14 => [
			'nr' => 14,
			'db_field' => 'hardware',
			'title' => t('zapi', 'Hardware')
		],
		15 => [
			'nr' => 15,
			'db_field' => 'hardware_full',
			'title' => t('zapi', 'Hardware (Full details)')
		],
		16 => [
			'nr' => 16,
			'db_field' => 'software',
			'title' => t('zapi', 'Software')
		],
		17 => [
			'nr' => 17,
			'db_field' => 'software_full',
			'title' => t('zapi', 'Software (Full details)')
		],
		18 => [
			'nr' => 18,
			'db_field' => 'software_app_a',
			'title' => t('zapi', 'Software application A')
		],
		19 => [
			'nr' => 19,
			'db_field' => 'software_app_b',
			'title' => t('zapi', 'Software application B')
		],
		20 => [
			'nr' => 20,
			'db_field' => 'software_app_c',
			'title' => t('zapi', 'Software application C')
		],
		21 => [
			'nr' => 21,
			'db_field' => 'software_app_d',
			'title' => t('zapi', 'Software application D')
		],
		22 => [
			'nr' => 22,
			'db_field' => 'software_app_e',
			'title' => t('zapi', 'Software application E')
		],
		23 => [
			'nr' => 23,
			'db_field' => 'contact',
			'title' => t('zapi', 'Contact')
		],
		24 => [
			'nr' => 24,
			'db_field' => 'location',
			'title' => t('zapi', 'Location')
		],
		25 => [
			'nr' => 25,
			'db_field' => 'location_lat',
			'title' => t('zapi', 'Location latitude')
		],
		26 => [
			'nr' => 26,
			'db_field' => 'location_lon',
			'title' => t('zapi', 'Location longitude')
		],
		27 => [
			'nr' => 27,
			'db_field' => 'notes',
		...
		32 => [
			...
			'title' => t('zapi', 'Contract number')
		],
		33 => [
			'nr' => 33,
			'db_field' => 'installer_name',
			'title' => t('zapi', 'Installer name')
		],
		34 => [
			'nr' => 34,
			'db_field' => 'deployment_status',
			'title' => t('zapi', 'Deployment status')
		],
		35 => [
			'nr' => 35,
			'db_field' => 'url_a',
		...
		38 => [
			...
			'title' => t('zapi', 'Host networks')
		],
		39 => [
			'nr' => 39,
			'db_field' => 'host_netmask',
			'title' => t('zapi', 'Host subnet mask')
		],
		40 => [
			'nr' => 40,
			'db_field' => 'host_router',
			'title' => t('zapi', 'Host router')
		],
		41 => [
			'nr' => 41,
			'db_field' => 'oob_ip',
			'title' => t('zapi', 'OOB IP address')
		],
		42 => [
			'nr' => 42,
			'db_field' => 'oob_netmask',
			'title' => t('zapi', 'OOB subnet mask')
		],
		43 => [
			'nr' => 43,
			'db_field' => 'oob_router',
			'title' => t('zapi', 'OOB router')
		],
		44 => [
			'nr' => 44,
			'db_field' => 'date_hw_purchase',
			'title' => t('zapi', 'Date HW purchased')
		],
		45 => [
			'nr' => 45,
			'db_field' => 'date_hw_install',
			'title' => t('zapi', 'Date HW installed')
		],
		46 => [
			'nr' => 46,
			'db_field' => 'date_hw_expiry',
			'title' => t('zapi', 'Date HW maintenance expires')
		],
		47 => [
			'nr' => 47,
			'db_field' => 'date_hw_decomm',
			'title' => t('zapi', 'Date HW decommissioned')
		],
		48 => [
			'nr' => 48,
			'db_field' => 'site_address_a',
			'title' => t('zapi', 'Site address A')
		],
		49 => [
			'nr' => 49,
			'db_field' => 'site_address_b',
			'title' => t('zapi', 'Site address B')
		],
		50 => [
			'nr' => 50,
			'db_field' => 'site_address_c',
			'title' => t('zapi', 'Site address C')
		],
		51 => [
			'nr' => 51,
			'db_field' => 'site_city',
			'title' => t('zapi', 'Site city')
		],
		52 => [
			'nr' => 52,
			'db_field' => 'site_state',
			'title' => t('zapi', 'Site state / province')
		],
		53 => [
			'nr' => 53,
			'db_field' => 'site_country',
			'title' => t('zapi', 'Site country')
		],
		54 => [
			'nr' => 54,
			'db_field' => 'site_zip',
			'title' => t('zapi', 'Site ZIP / postal')
		],
		55 => [
			'nr' => 55,
			'db_field' => 'site_rack',
			'title' => t('zapi', 'Site rack location')
		],
		56 => [
			'nr' => 56,
			'db_field' => 'site_notes',
			'title' => t('zapi', 'Site notes')
		],
		57 => [
			'nr' => 57,
			'db_field' => 'poc_1_name',
			'title' => t('zapi', 'Primary POC name')
		],
		58 => [
			'nr' => 58,
			'db_field' => 'poc_1_email',
			'title' => t('zapi', 'Primary POC email')
		],
		59 => [
			'nr' => 59,
			'db_field' => 'poc_1_phone_a',
			'title' => t('zapi', 'Primary POC phone A')
		],
		60 => [
			'nr' => 60,
			'db_field' => 'poc_1_phone_b',
			'title' => t('zapi', 'Primary POC phone B')
		],
		61 => [
			'nr' => 61,
			'db_field' => 'poc_1_cell',
			'title' => t('zapi', 'Primary POC cell')
		],
		62 => [
			'nr' => 62,
			'db_field' => 'poc_1_screen',
			'title' => t('zapi', 'Primary POC screen name')
		],
		63 => [
			'nr' => 63,
			'db_field' => 'poc_1_notes',
			'title' => t('zapi', 'Primary POC notes')
		],
		64 => [
			'nr' => 64,
			'db_field' => 'poc_2_name',
			'title' => t('zapi', 'Secondary POC name')
		],
		65 => [
			'nr' => 65,
			'db_field' => 'poc_2_email',
			'title' => t('zapi', 'Secondary POC email')
		],
		66 => [
			'nr' => 66,
			'db_field' => 'poc_2_phone_a',
			'title' => t('zapi', 'Secondary POC phone A')
		],
		67 => [
			'nr' => 67,
			'db_field' => 'poc_2_phone_b',
			'title' => t('zapi', 'Secondary POC phone B')
		],
		68 => [
			'nr' => 68,
			'db_field' => 'poc_2_cell',
			'title' => t('zapi', 'Secondary POC cell')
		],
		69 => [
			'nr' => 69,
			'db_field' => 'poc_2_screen',
			'title' => t('zapi', 'Secondary POC screen name')
		],
		70 => [
			'nr' => 70,
			'db_field' => 'poc_2_notes',
			'title' => t('zapi', 'Secondary POC notes')
		]
	];
...
function hostInterfaceTypeNumToName($type) {
	switch ($type) {
		...
		case INTERFACE_TYPE_IPMI:
			...
			break;
		default:
			throw new Exception(t('zapi', 'Unknown interface type.'));
	}
...
function get_host_by_hostid($hostid, $no_error_message = 0) {
	$row = DBfetch(DBselect('SELECT h.* FROM hosts h WHERE h.hostid='.prs_dbstr($hostid)));
	...
	if ($no_error_message == 0) {
		error(t('zapi', 'No host with host ID "{value}".', ['value' => $hostid]));
	}
...
function makeHostPrototypeTemplatePrefix($host_prototypeid, array $parent_templates, bool $provide_links) {
	...
	if ($provide_links && $template['permission'] == PERM_READ_WRITE) {
		...
		))->addClass(PRS_STYLE_LINK_ALT);
	}
	else {
		$name = new CSpan($template['name']);
	}

	return [$name->addClass(PRS_STYLE_GREY), NAME_DELIMITER];
}
...
function makeHostPrototypeTemplatesHtml($host_prototypeid, array $parent_templates, bool $provide_links) {
	...
	while (array_key_exists($host_prototypeid, $parent_templates['links'])) {
		...
		if ($provide_links && $template['permission'] == PERM_READ_WRITE) {
			...
			$name = (new CSpan($template['name']))->addClass(PRS_STYLE_GREY);
		}
...
function isTemplate($hostId) {
	$dbHost = DBfetch(DBselect('SELECT h.status FROM hosts h WHERE h.hostid='.prs_dbstr($hostId)));
...
function getHostInventoryModes() {
	return [
		HOST_INVENTORY_DISABLED => t('zapi', 'Disabled'),
		HOST_INVENTORY_MANUAL => t('zapi', 'Manual'),
		HOST_INVENTORY_AUTOMATIC => t('zapi', 'Automatic')
	];
}
...
function getAddNewInterfaceSubmenu() {
	return [
		'main_section' => [
			'items' => [
				"javascript:hostInterfaceManager.addAgent();" => t('zapi', 'Agent'),
				"javascript:hostInterfaceManager.addSnmp();" => t('zapi', 'SNMP'),
				"javascript:hostInterfaceManager.addJmx();" => t('zapi', 'JMX'),
				"javascript:hostInterfaceManager.addIpmi();" => t('zapi', 'IPMI')
			]
		]
	];
}
...
function renderInterfaceHeaders() {
	return (new CDiv())
		->addClass(implode(' ', [PRS_STYLE_HOST_INTERFACE_CONTAINER, PRS_STYLE_HOST_INTERFACE_CONTAINER_HEADER]))
		->addItem(
			(new CDiv())
				->addClass(implode(' ', [PRS_STYLE_HOST_INTERFACE_ROW, PRS_STYLE_HOST_INTERFACE_ROW_HEADER]))
				->addItem([
					(new CDiv())->addClass(PRS_STYLE_HOST_INTERFACE_CELL),
					(new CDiv(t('zapi', 'Type')))->addClass(
						implode(' ', [PRS_STYLE_HOST_INTERFACE_CELL, PRS_STYLE_HOST_INTERFACE_CELL_HEADER,
							PRS_STYLE_HOST_INTERFACE_CELL_TYPE
						])
					),
					(new CDiv(t('zapi', 'IP address')))->addClass(
						implode(' ', [PRS_STYLE_HOST_INTERFACE_CELL, PRS_STYLE_HOST_INTERFACE_CELL_HEADER,
							PRS_STYLE_HOST_INTERFACE_CELL_IP
						])
					),
					(new CDiv(t('zapi', 'DNS name')))->addClass(
						implode(' ', [PRS_STYLE_HOST_INTERFACE_CELL, PRS_STYLE_HOST_INTERFACE_CELL_HEADER,
							PRS_STYLE_HOST_INTERFACE_CELL_DNS
						])
					),
					(new CDiv(t('zapi', 'Connect to')))->addClass(
						implode(' ', [PRS_STYLE_HOST_INTERFACE_CELL, PRS_STYLE_HOST_INTERFACE_CELL_HEADER,
							PRS_STYLE_HOST_INTERFACE_CELL_USEIP
						])
					),
					(new CDiv(t('zapi', 'Port')))->addClass(
						implode(' ', [PRS_STYLE_HOST_INTERFACE_CELL, PRS_STYLE_HOST_INTERFACE_CELL_HEADER,
							PRS_STYLE_HOST_INTERFACE_CELL_PORT
						])
					),
					(new CDiv(t('zapi', 'Default')))->addClass(
						implode(' ', [PRS_STYLE_HOST_INTERFACE_CELL, PRS_STYLE_HOST_INTERFACE_CELL_HEADER,
							PRS_STYLE_HOST_INTERFACE_CELL_ACTION
						])
					)
				])
		);
...
function getMacroConfigValue(array $macro): string {
	return ($macro['type'] == PRS_MACRO_TYPE_SECRET) ? PRS_SECRET_MASK : $macro['value'];
}
