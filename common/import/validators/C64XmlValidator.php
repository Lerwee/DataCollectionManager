...
/**
 * Validate import data from Perseus 6.4.x.
 */
class C64XmlValidator extends CXmlValidatorGeneral {
	...
	private $ITEM_TYPE = [
		CXmlConstantValue::ITEM_TYPE_PERSEUS_PASSIVE => CXmlConstantName::PERSEUS_PASSIVE,
		...
		CXmlConstantValue::ITEM_TYPE_PERSEUS_ACTIVE => CXmlConstantName::PERSEUS_ACTIVE,
				...
				'host' =>					['type' => XML_ARRAY, 'rules' => [
					...
					'interfaces' =>				['type' => XML_INDEXED_ARRAY, 'prefix' => 'interface', 'rules' => [
						'interface' =>				['type' => XML_ARRAY, 'rules' => [
							...
							'type' =>					['type' => XML_STRING, 'default' => CXmlConstantValue::PERSEUS, 'in' => [CXmlConstantValue::PERSEUS => CXmlConstantName::PERSEUS, CXmlConstantValue::SNMP => CXmlConstantName::SNMP, CXmlConstantValue::IPMI => CXmlConstantName::IPMI, CXmlConstantValue::JMX => CXmlConstantName::JMX]],
					...
					'items' =>					['type' => XML_INDEXED_ARRAY, 'prefix' => 'item', 'rules' => [
						'item' =>					['type' => XML_ARRAY, 'rules' => [
							'name' =>					['type' => XML_STRING | XML_REQUIRED],
							'type' =>					['type' => XML_STRING, 'default' => CXmlConstantValue::ITEM_TYPE_PERSEUS_PASSIVE, 'in' => $this->ITEM_TYPE],
							...
							'delay' =>					['type' => XML_MULTIPLE, 'rules' => [
															['if' => ['tag' => 'type', 'in' => [CXmlConstantValue::ITEM_TYPE_PERSEUS_ACTIVE => CXmlConstantName::PERSEUS_ACTIVE]], 'type' => XML_MULTIPLE, 'rules' => [
					...
					'discovery_rules' =>		['type' => XML_INDEXED_ARRAY, 'prefix' => 'discovery_rule', 'rules' => [
						'discovery_rule' =>			['type' => XML_ARRAY, 'rules' => [
							'name' =>					['type' => XML_STRING | XML_REQUIRED],
							'type' =>					['type' => XML_STRING, 'default' => CXmlConstantValue::ITEM_TYPE_PERSEUS_PASSIVE, 'in' => $this->ITEM_TYPE_DRULE],
					...
					'httptests' =>				['type' => XML_INDEXED_ARRAY, 'prefix' => 'httptest', 'rules' => [
						'httptest' =>				['type' => XML_ARRAY, 'rules' => [
							...
							'agent' =>					['type' => XML_STRING, 'default' => 'Perseus'],
							'http_proxy' =>				['type' => XML_STRING, 'default' => ''],
	...
	public function requiredMapElement(array $parent_data = null) {
		if (prs_is_int($parent_data['elementtype'])) {
