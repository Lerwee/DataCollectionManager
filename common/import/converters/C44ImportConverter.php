...
class C44ImportConverter extends CConverter {
	...
	public function convert($data): array {
		$data['perseus_export']['version'] = '5.0';

		if (array_key_exists('hosts', $data['perseus_export'])) {
			$data['perseus_export']['hosts'] = $this->convertSnmpFieldsToInterfaces($data['perseus_export']['hosts']);
		}

		$data['perseus_export'] = $this->sanitizeSnmpFields($data['perseus_export']);
