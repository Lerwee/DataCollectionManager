...
use app\customs\zapi\common\import\converters\C10ItemKeyConverter;
use app\customs\zapi\common\import\converters\C10TriggerConverter;
...
class C10ImportConverter extends CConverter {
	...
	protected function convertDependencies(array $content) {
		...
		$hosts = prs_toHash($content['hosts'], 'name');
