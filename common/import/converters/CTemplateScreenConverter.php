		...
		switch ($screen_item['resourcetype']) {
			...
			case self::SCREEN_RESOURCE_TYPE_GRAPH:
				...
				$widget['fields'][] = [
					'type' => CXmlConstantName::DASHBOARD_WIDGET_FIELD_TYPE_INTEGER,
					'name' => 'source_type',
					'value' => (string) PRS_WIDGET_FIELD_RESOURCE_GRAPH
				];
				$widget['fields'][] = [
			...
			case self::SCREEN_RESOURCE_TYPE_SIMPLE_GRAPH:
				...
				$widget['fields'][] = [
					'type' => CXmlConstantName::DASHBOARD_WIDGET_FIELD_TYPE_INTEGER,
					'name' => 'source_type',
					'value' => (string) PRS_WIDGET_FIELD_RESOURCE_SIMPLE_GRAPH
				];
				$widget['fields'][] = [
					'type' => CXmlConstantName::DASHBOARD_WIDGET_FIELD_TYPE_ITEM,
					'name' => 'itemid',
			...
			case self::SCREEN_RESOURCE_TYPE_LLD_GRAPH:
				...
				$widget['fields'][] = [
					'type' => CXmlConstantName::DASHBOARD_WIDGET_FIELD_TYPE_INTEGER,
					'name' => 'source_type',
					'value' => (string) PRS_WIDGET_FIELD_RESOURCE_GRAPH_PROTOTYPE
				];
				$widget['fields'][] = [
			...
			case self::SCREEN_RESOURCE_TYPE_LLD_SIMPLE_GRAPH:
				...
				$widget['fields'][] = [
					'type' => CXmlConstantName::DASHBOARD_WIDGET_FIELD_TYPE_INTEGER,
					'name' => 'source_type',
					'value' => (string) PRS_WIDGET_FIELD_RESOURCE_SIMPLE_GRAPH_PROTOTYPE
				];
				$widget['fields'][] = [
