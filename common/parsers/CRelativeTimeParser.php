...
class CRelativeTimeParser extends CParser {
	...
	const PRS_TOKEN_PRECISION = 0;
	const PRS_TOKEN_OFFSET = 1;
	...
	public function getDateTime($is_start, \DateTimeZone $timezone = null): ?\DateTime {
		...
		foreach ($this->getTokens() as $token) {
			switch ($token['type']) {
				case CRelativeTimeParser::PRS_TOKEN_PRECISION:
				...
				case CRelativeTimeParser::PRS_TOKEN_OFFSET:
					$units = [
						's' => 'second',
						'm' => 'minute',
						'h' => 'hour',
