...
class CItemKey extends CParser {
	...
	public function __construct($options = []) {
		$this->error_msgs['empty'] = t('zapi', 'key is empty');
		$this->error_msgs['unexpected_end'] = t('zapi', 'unexpected end of key');
	 ...
	 * this function is a copy of prs_is_key_char() from src/libs/zbxexpr/expr.c
